...
public class Ex01_String_basic {
	...
	public static void main(String[] args) {
		...
		// 사용형태 2가지 --------
		// 1. String str = "홍길동"; //기본 데이터 타입처럼 사용 가능 : 상수값처럼 공유해서 사용 
		// 2. String str = new String("홍길동"); //객체(인스턴스) 생성 방식
		// ---------------- 
		String str1 = "홍길동";
		String str2 = "홍길동";
		...
		System.out.println("str0bj1:" + strObj1);
		...
		System.out.println("--- 문자열 값 비교 equals() 메소드 사용---");
