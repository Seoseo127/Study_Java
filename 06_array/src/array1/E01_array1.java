...
public class E01_array1 {

	public static void main(String[] args) {
		// 배열(array): 동일한 데이터 타입들의 연속된 저장공간
		// 배열의 선언: 자료형[] 변수명;
		// 배열의 값 저장: 배열변수명 [인덱스번호] = 값;
		
		/* 배열의 선언 및 생성
		 1. 자료형[] 변수명 = new 자료형[크기];
		    자료형 변수명[] = new 자료형[크기];
		 2. 자료형[] 변수명 = new 자료형[] {값1, 값2, 값, .., 값n};
		 3. 자료형[] 변수명 = {값1, 값2, 값, .., 값n}; //n개의 저장공간 생성 + 값저장
		------------ */
		...
		System.out.println("arr.length :" + arr.length); //총길이
		for (int i = 0; i < 5; i++) {
